package com.sunyjams.common.crash;

import android.content.Context;
import android.text.TextUtils;

import com.sunyjams.common.utils.md5.MD5;
import com.sunyjams.common.utils.storage.StorageType;
import com.sunyjams.common.utils.storage.StorageUtils;
...
public class CrashSaver {
    ...
    public static final void save(Context context, Throwable ex,
        ...
        if (!StorageUtils.isExternalStorageExist()) {// 如果没有sdcard，则不存储
            return;
        }
        Writer writer = null;
        ...
        try {
            File mFile = new File(StorageUtils.getWritePath(
